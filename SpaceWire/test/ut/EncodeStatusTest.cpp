TEST(EncodeStatusTest, ADDR_TYPE_MISMATCHTest) {
  U8 dat[1] = {0xFF};

  SpaceWire::RMAPPacket packet = SpaceWire::RMAPPacket();
  packet.set(SpaceWire::SpaceWireAddr(0x54, dat, 0, SpaceWire::SpaceWireAddrType::LOGICAL, 0),
             SpaceWire::SpaceWireAddr(0x76, dat, 0, SpaceWire::SpaceWireAddrType::PHYSICAL, 0),
...
TEST(EncodeStatusTest, DATA_LEN_OVERRUNTest) {
  U8 dat[1] = {0xFF};

  SpaceWire::RMAPPacket packet = SpaceWire::RMAPPacket();
  packet.set(SpaceWire::SpaceWireAddr(0x54, dat, 0, SpaceWire::SpaceWireAddrType::LOGICAL, 0),
             SpaceWire::SpaceWireAddr(0x76, dat, 0, SpaceWire::SpaceWireAddrType::LOGICAL, 0),
...
TEST(EncodeStatusTest, DATA_LEN_MISMATCHTest) {
  U8 dat[1] = {0xFF};
...
TEST(EncodeStatusTest, BUFFER_LEN_MISMATCHTest) {
  U8 dat[1] = {0xFF};
...
/* // Not yet implemented
TEST(EncodeStatusTest, RMW_DATA_MISMATCHTest) {
  U8 dat[1] = {0xFF};
